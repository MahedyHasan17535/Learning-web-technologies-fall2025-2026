        ...
        <fieldset>
            ...
            <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $medicine['generic_name'] ? $medicine['generic_name'] : 'N/A'; ?>
                    </td>
                </tr>
                <tr>
                    <td><strong>Category:</strong></td>
                    <td>
                        <?php echo $medicine['category'] ? $medicine['category'] : 'N/A'; ?>
                    </td>
                </tr>
                <tr>
                    <td><strong>Manufacturer:</strong></td>
                    <td>
                        <?php echo $medicine['manufacturer'] ? $medicine['manufacturer'] : 'N/A'; ?>
                    </td>
                </tr>
                <tr>
                    <td><strong>Description:</strong></td>
                    <td>
                        <?php echo $medicine['description'] ? $medicine['description'] : 'N/A'; ?>
                    </td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset>
            ...
            <table cellpadding="5">
                <tr>
                    ...
                    <td>
                        <?php echo number_format($medicine['unit_price'], 2); ?> Tk
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $medicine['expiry_date'] ? $medicine['expiry_date'] : 'N/A'; ?>
                    </td>
                </tr>
            </table>
        </fieldset>
